...
class TimeEntriesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create time_entry" do
    assert_difference("TimeEntry.count") do
      post time_entries_url, params: { time_entry: { employee_id: @time_entry.employee_id, hours_worked: @time_entry.hours_worked, notes: @time_entry.notes, overtime_hours: @time_entry.overtime_hours, work_date: @time_entry.work_date } }
    end
  ...
  test "should update time_entry" do
    patch time_entry_url(@time_entry), params: { time_entry: { employee_id: @time_entry.employee_id, hours_worked: @time_entry.hours_worked, notes: @time_entry.notes, overtime_hours: @time_entry.overtime_hours, work_date: @time_entry.work_date } }
